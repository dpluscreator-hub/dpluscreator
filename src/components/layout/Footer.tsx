    ...
    <footer className="bg-dark text-white py-16">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a href="tel:+916265213360" className="hover:text-primary transition-colors">
                  +91 6265213360
                </a>
              </li>
              <li>
                <a href="mailto:dpluscreator@gmail.com" className="hover:text-primary transition-colors">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} DPLUS CREATOR. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
